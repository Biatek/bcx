...
class Calc {
  ...
  function getSillyNickname ($date) {
    ...
    $day = array("Hipo", "Lamb", "Chocolate", "Tommato", "Tiger", "Santa", "T-pot", "Superhero", "Cactus", "Brain", "Star", "Sausage", "Troll", "Dragon", "Banana", "Mole", "Flash", "Bunny", "Monkey", "Monster", "Clown", "Sweetheart", "Sock", "Bee", "Alien", "Angel", "Ghost", "Pirate", "Child", "Bear", "Champion");
